...
import 'bs_mostra_detalle_producto_model.dart';
export 'bs_mostra_detalle_producto_model.dart';

class BsMostraDetalleProductoWidget extends StatefulWidget {
  const BsMostraDetalleProductoWidget({
    super.key,
  ...
  @override
  State<BsMostraDetalleProductoWidget> createState() =>
      _BsMostraDetalleProductoWidgetState();
}

class _BsMostraDetalleProductoWidgetState
    extends State<BsMostraDetalleProductoWidget> {
  late BsMostraDetalleProductoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BsMostraDetalleProductoModel());
  }
