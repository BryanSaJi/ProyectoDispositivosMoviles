                            ...
                            Flexible(
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'xkn2y26y' /* Are you sure you want to chang... */,
                                ),
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        title: Text('Nueva contraseña'),
                                        content: Text(
                                            'La nueva contraseña no se ha podido cambiar, Codigo de error: ${_model.changeResult?.toString()}'),
                                        actions: [
                                          TextButton(
                                            onPressed: () => Navigator.pop(
                                                alertDialogContext),
