...
import 'bs_informacion_ordenes_admin_model.dart';
export 'bs_informacion_ordenes_admin_model.dart';

class BsInformacionOrdenesAdminWidget extends StatefulWidget {
  const BsInformacionOrdenesAdminWidget({
    super.key,
    required this.orden,
  });
  ...
  @override
  State<BsInformacionOrdenesAdminWidget> createState() =>
      _BsInformacionOrdenesAdminWidgetState();
}

class _BsInformacionOrdenesAdminWidgetState
    extends State<BsInformacionOrdenesAdminWidget>
    with TickerProviderStateMixin {
  late BsInformacionOrdenesAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BsInformacionOrdenesAdminModel());
                    ...
                    child: StreamBuilder<List<UsersRecord>>(
                      stream: queryUsersRecord(
                        queryBuilder: (usersRecord) => usersRecord.where(
                          'uid',
                          isEqualTo: widget!.orden?.orderUser?.id,
                        ),
                        singleRecord: true,
                      ),
                                ...
                                Flexible(
                                  child: Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text(
                                        valueOrDefault<String>(
                                          columnUsersRecord?.phone?.toString(),
                                          'Sin definir',
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
