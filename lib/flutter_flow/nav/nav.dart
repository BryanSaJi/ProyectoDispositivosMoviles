...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/vistaCreacionCuenta',
          builder: (context, params) => VistaCreacionCuentaWidget(),
        ),
        FFRoute(
          name: 'Verification',
          path: '/verification',
        ...
        FFRoute(
          name: 'vistaLogin',
          path: '/vistaLogin',
          builder: (context, params) => VistaLoginWidget(),
        ),
        FFRoute(
          name: 'vistaIndex',
          path: '/vistaIndex',
        ...
        FFRoute(
          name: 'vistaCarrito',
          path: '/vistaCarrito',
          builder: (context, params) => VistaCarritoWidget(),
        ),
        FFRoute(
          name: 'vistaPago',
          path: '/vistaPago',
        ...
        FFRoute(
          name: 'vistaLenguaje',
          path: '/vistaLenguaje',
          builder: (context, params) => VistaLenguajeWidget(),
        ),
        FFRoute(
