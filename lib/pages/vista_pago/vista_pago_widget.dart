...
class VistaPagoWidget extends StatefulWidget {
  const VistaPagoWidget({
    super.key,
    this.prmMetodoPago,
    this.prmNombreMetodoPago,
    this.prmNumeroTarjeta,
  });

  final DocumentReference? prmMetodoPago;
  final String? prmNombreMetodoPago;
  final String? prmNumeroTarjeta;
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<CartRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CartRecord> vistaPagoCartRecordList = snapshot.data!;
                                                                  ...
                                                                  Expanded(
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            listViewCartRecord.nameProduct,
                                                                  ...
                                                                  Column(
                                                                    ...
                                                                    children: [
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                            Text(
                                                                          '₡ ${functions.funcSubtotal(listViewCartRecord.subtotal, listViewCartRecord.quantity).toString()}',
                                                                          textAlign:
                                                                              TextAlign.end,
                                            ...
                                            Expanded(
                                              child: StreamBuilder<
                                                ...
                                                builder: (context, snapshot) {
                                                  ...
                                                  List<ProductRecord>
                                                      buttonProductRecordList =
                                                      snapshot.data!;

                                                  return FFButtonWidget(
                                                    onPressed: () async {
                                                      if (widget!.prmMetodoPago
                                                                  ?.id !=
                                                              null &&
                                                          widget!.prmMetodoPago
                                                                  ?.id !=
                                                              '') {
                                                          ...
                                                          ...mapToFirestore(
                                                            {
                                                              'OrderDate':
                                                                  FieldValue
                                                                      .serverTimestamp(),
                                                              'Product': vistaPagoCartRecordList
                                                                  .map((e) =>
                                                                      e.product)
                                                                  .withoutNulls
                                                                  .toList(),
