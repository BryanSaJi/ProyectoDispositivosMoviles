...
class _ChangePasswordWidgetState extends State<ChangePasswordWidget> {
  ...
  void initState() {
    ...
    _model.txtcurrentPasswordTextController ??= TextEditingController();
    _model.txtcurrentPasswordFocusNode ??= FocusNode();
                                            ...
                                            children: [
                                              Expanded(
                                                child: Container(
                                                  ...
                                                  child: TextFormField(
                                                    controller: _model
                                                        .txtcurrentPasswordTextController,
                                                    focusNode: _model
                                                        .txtcurrentPasswordFocusNode,
                                                    autofocus: false,
                                                    autofillHints: [
                                                      AutofillHints.password
                                                    ],
                                                    obscureText: !_model
                                                        .txtcurrentPasswordVisibility,
                                                    decoration: InputDecoration(
                                                      ...
                                                      hintText:
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                        '1f0qtr4a' /* Enter current password */,
                                                      ),
                                                      hintStyle:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                      ...
                                                      prefixIcon: Icon(
                                                        ...
                                                        color: valueOrDefault<
                                                            Color>(
                                                          _model.txtcurrentPasswordTextController
                                                                          .text ==
                                                                      null ||
                                                                  _model.txtcurrentPasswordTextController
                                                                          .text ==
                                                      ...
                                                      suffixIcon: InkWell(
                                                        ...
                                                        focusNode: FocusNode(
                                                            skipTraversal:
                                                                true),
                                                        child: Icon(
                                                          _model.txtcurrentPasswordVisibility
                                                              ? Icons
                                                                  .visibility_outlined
                                                              : Icons
                                                    ...
                                                    decoration: InputDecoration(
                                                      ...
                                                      hintText:
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                        '8nvgwzru' /* Confirm your new password */,
                                                      ),
                                                      hintStyle:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                    ...
                                    if (_model
                                      ...
                                      await showDialog(
                                        ...
                                        builder: (alertDialogContext) {
                                          return AlertDialog(
                                            content: Text(
                                                'La confirmacion de la contraseña no es igual a la contraseña ingresada'),
                                            actions: [
                                              TextButton(
