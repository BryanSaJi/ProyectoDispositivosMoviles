...
import 'vista_editar_perfil_model.dart';
export 'vista_editar_perfil_model.dart';

class VistaEditarPerfilWidget extends StatefulWidget {
  const VistaEditarPerfilWidget({super.key});

  @override
  State<VistaEditarPerfilWidget> createState() =>
      _VistaEditarPerfilWidgetState();
}

class _VistaEditarPerfilWidgetState extends State<VistaEditarPerfilWidget> {
  late VistaEditarPerfilModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VistaEditarPerfilModel());
    ...
    _model.rolTextFieldTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.rol, ''));
    _model.rolTextFieldFocusNode ??= FocusNode();

    _model.switchValue =
        valueOrDefault<bool>(currentUserDocument?.enable, false);
  }
                                                    ...
                                                    decoration: InputDecoration(
                                                      ...
                                                      hintText:
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                        '2tjuy3lv' /* Enter your email or phone numb... */,
                                                      ),
                                                      hintStyle:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                      ...
                                                      decoration:
                                                        ...
                                                        hintText:
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                          'jcpib5pt' /* Enter your email or phone numb... */,
                                                        ),
                                                        hintStyle:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                        ...
                                                        decoration:
                                                          ...
                                                          hintText:
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                            'nyr4uvds' /* Enter your email or phone numb... */,
                                                          ),
                                                          hintStyle:
                                                              FlutterFlowTheme.of(
                                                                      context)
                                                          ...
                                                          prefixIcon: Icon(
                                                            ...
                                                            color:
                                                                valueOrDefault<
                                                                    Color>(
                                                              _model.rolTextFieldTextController.text ==
                                                                          null ||
                                          ...
                                          await showDialog(
                                            ...
                                            builder: (alertDialogContext) {
                                              return AlertDialog(
                                                ...
                                                content: Text(
                                                    'El usuario ${valueOrDefault(currentUserDocument?.name, '')}${valueOrDefault(currentUserDocument?.lastName, '')} ha sido actualizado'),
                                                actions: [
                                                  TextButton(
                                                    onPressed: () =>
                                                        Navigator.pop(
