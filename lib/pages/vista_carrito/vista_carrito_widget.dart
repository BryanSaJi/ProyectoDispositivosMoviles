...
import 'vista_carrito_model.dart';
export 'vista_carrito_model.dart';

class VistaCarritoWidget extends StatefulWidget {
  const VistaCarritoWidget({super.key});

  @override
  State<VistaCarritoWidget> createState() => _VistaCarritoWidgetState();
}

class _VistaCarritoWidgetState extends State<VistaCarritoWidget> {
  late VistaCarritoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VistaCarritoModel());
  }
