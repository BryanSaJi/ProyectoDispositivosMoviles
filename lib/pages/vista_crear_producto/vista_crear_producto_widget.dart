...
import 'vista_crear_producto_model.dart';
export 'vista_crear_producto_model.dart';

class VistaCrearProductoWidget extends StatefulWidget {
  const VistaCrearProductoWidget({super.key});

  @override
  State<VistaCrearProductoWidget> createState() =>
      _VistaCrearProductoWidgetState();
}

class _VistaCrearProductoWidgetState extends State<VistaCrearProductoWidget> {
  late VistaCrearProductoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VistaCrearProductoModel());
