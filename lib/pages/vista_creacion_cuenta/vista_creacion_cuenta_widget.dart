...
import 'vista_creacion_cuenta_model.dart';
export 'vista_creacion_cuenta_model.dart';

class VistaCreacionCuentaWidget extends StatefulWidget {
  const VistaCreacionCuentaWidget({super.key});

  @override
  State<VistaCreacionCuentaWidget> createState() =>
      _VistaCreacionCuentaWidgetState();
}

class _VistaCreacionCuentaWidgetState extends State<VistaCreacionCuentaWidget> {
  late VistaCreacionCuentaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VistaCreacionCuentaModel());
                                                    ...
                                                    decoration: InputDecoration(
                                                      ...
                                                      hintText:
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                        'rnzvwmdo' /* Enter your phone number */,
                                                      ),
                                                      hintStyle:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                              ...
                                              Expanded(
                                                child: Container(
                                                  ...
                                                  child: TextFormField(
                                                    ...
                                                    focusNode: _model
                                                        .txtPasswordConfFocusNode,
                                                    autofocus: false,
                                                    autofillHints: [
                                                      AutofillHints.password
                                                    ],
                                                    obscureText: !_model
                                                        .txtPasswordConfVisibility,
                                                    decoration: InputDecoration(
                                                      isDense: false,
                                                      labelStyle:
                                                          FlutterFlowTheme.of(
                                                      ...
                                                      hintText:
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                        'qctrjaei' /* Confirm your password */,
                                                      ),
                                                      hintStyle:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                      ...
                                                      prefixIcon: Icon(
                                                        ...
                                                        color: valueOrDefault<
                                                            Color>(
                                                          _model.txtPasswordConfTextController
                                                                          .text ==
                                                                      null ||
                                                                  _model.txtPasswordConfTextController
                                                                          .text ==
                                                      ...
                                                      suffixIcon: InkWell(
                                                        ...
                                                        focusNode: FocusNode(
                                                            skipTraversal:
                                                                true),
                                                        child: Icon(
                                                          _model.txtPasswordConfVisibility
                                                              ? Icons
                                                                  .visibility_outlined
                                                              : Icons
                                                                  .visibility_off_outlined,
