...
class _EditProductWidgetState extends State<EditProductWidget> {
  ...
  void initState() {
    ...
    _model.txtDescripcionTextController ??=
        TextEditingController(text: widget!.product?.descriptionProduct);
    _model.txtDescripcionFocusNode ??= FocusNode();

    _model.txtTiempoTextController ??=
        TextEditingController(text: widget!.product?.timeProduct?.toString());
    _model.txtTiempoFocusNode ??= FocusNode();

    _model.txtSaborTextController ??=
        TextEditingController(text: widget!.product?.sabor);
    _model.txtSaborFocusNode ??= FocusNode();

    _model.switchValue = widget!.product!.enable;
  }
                                                    ...
                                                    decoration: InputDecoration(
                                                      ...
                                                      hintText:
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                        '9diuoplu' /* Enter your email or phone numb... */,
                                                      ),
                                                      hintStyle:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                              ...
                                              Expanded(
                                                child: Container(
                                                  ...
                                                  child: TextFormField(
                                                    ...
                                                    validator: _model
                                                        .txtSaborTextControllerValidator
                                                        .asValidator(context),
                                                  ),
                                                ),
                                              ),
                                          ...
                                          if (confirmDialogResponse) {
                                            ...
                                            await showDialog(
                                              ...
                                              builder: (alertDialogContext) {
                                                return AlertDialog(
                                                  content: Text(
                                                      'El producto: ${widget!.product?.nameProduct} ha sido actualizado.'),
                                                  actions: [
                                                    TextButton(
                                                      onPressed: () =>
                                                          Navigator.pop(
